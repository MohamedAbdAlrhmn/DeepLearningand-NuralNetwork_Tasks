...
class PreProcessing:
    ...
    def visualization(self):
        ...
        plt.ylabel('bill_depth', fontsize=15)
        ...
        plt.figure('fig2')
        plt.xlabel("bill_length", fontsize=15)
        plt.ylabel('flipper_length', fontsize=15)
        ...
        plt.figure('fig4')
        plt.xlabel("bill_length", fontsize=15)
        plt.ylabel('body_mass', fontsize=15)
        ...
        plt.figure('fig5')
        plt.xlabel("bill_depth", fontsize=15)
        plt.ylabel('flipper_length', fontsize=15)
        ...
        plt.figure('fig8')
        plt.xlabel("flipper_length", fontsize=15)
        plt.ylabel('gender', fontsize=15)
