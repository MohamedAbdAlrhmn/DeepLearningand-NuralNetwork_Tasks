...
class Perceptron:
    ...
    def Train_Data(self, feature1, feature2, classes, epoch, learning_rate, mse, bias):
        ...
        for z in range(epoch):
            for i in range(60):
                ...
                mse_threshold += (error ** 2) / 2.0
            totalmse = mse_threshold / (2.0*60.0)
            print(z)
            if totalmse < mse:
                break
            else:
